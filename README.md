...
# ReactJS & NodeJS - Full ECommerce Website

A fully-functional e-commerce website exactly like amazon. Here I build an e-commerce website using MERN stack (MongoDB, ExpressJS, React and Node.JS).
...
```
$ git clone git@github.com:promehedi/amazona.git
$ cd amazona
```
